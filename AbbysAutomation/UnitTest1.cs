...
namespace AbbysAutomation
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void Hmwrk3_PassionTea_CSSSelector()
        {
            ...
            driver.FindElement(By.CssSelector("[name='name']")).SendKeys("Abby");
            driver.FindElement(By.CssSelector("[name='email']")).SendKeys("Abby@gmail.com");
            driver.FindElement(By.CssSelector("[name='subject']")).SendKeys("Info");
            driver.FindElement(By.CssSelector("[name='message']")).SendKeys("Here is my message");
            driver.FindElement(By.CssSelector("[value='Submit']")).Click();
            IWebElement ConfMessage = driver.FindElement(By.Id("msg_78ea690540a24bd8b9dcfbf99e999fea"));
            string messageText = ConfMessage.Text;
            Assert.AreEqual(messageText, "");
